...
1. [AI_CONTEXT.md](file:///d:/HermesJang/CMCC/tools/lambert/lamber/docs/AI_CONTEXT.md)
2. [PROJECT_STATUS.md](file:///d:/HermesJang/CMCC/tools/lambert/lamber/docs/PROJECT_STATUS.md)
3. [ARCHITECTURE_MAP.md](file:///d:/HermesJang/CMCC/tools/lambert/lamber/docs/ARCHITECTURE_MAP.md)
4. [CHANGELOG_AI.md](file:///d:/HermesJang/CMCC/tools/lambert/lamber/docs/CHANGELOG_AI.md)
...
- **UI Design System**: Follow "The Architectural Ledger" guidelines in [DESIGN.md](file:///d:/HermesJang/CMCC/tools/lambert/lamber/DESIGN.md). Adhere to the "No-Line Rule" (tonal surface changes instead of borders), using rounded corners (`ROUND_FOUR`), the `Inter` font family, and tabular numbers for numerical displays.
